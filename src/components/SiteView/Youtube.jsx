  ...
  const data = [
    {
      ...
      view: "1.164.893.608 lượt xem",
      like: "13 triệu",
      author: "Rick Astley",
      sub: "2,94 Tr người đăng ký",
      comment: "2,080,435 bình luận",
      id: "dQw4w9WgXcQ",
    },
    {
      title: "[Lyric video] Bước đều bước - B Ray",
      view: "13.760.734 lượt xem",
      like: "80 N",
      author: "EvB Records",
      sub: "1,58 Tr người đăng ký",
      comment: "4,435 bình luận",
      id: "92IFndCYGi8",
    },
    {
      title: "Interstellar - Years of Messages Scene 1080p HD",
      view: "5.306.440 lượt xem",
      like: "59 N",
      author: "Jay M",
      sub: "24,9 N người đăng ký",
      comment: "4,835 bình luận",
      id: "MoLkabPK3YU",
    },
    {
      title: "Datmaniac x Tuimi - Coming Home (Prod by NguyenHongGiang )",
      view: "2.285.659 lượt xem",
      like: "31 N",
      author: "CROW ON HYENAS",
      sub: "284 N người đăng ký",
  ...
  return (
    <div className="youtube p-1">
      <div className="youtube-header row">
        <div className=" m-0 col-12 col-sm-3 text-sm-start text-center">
          <div class="youtube-logo-icon ytd-topbar-logo-renderer p-3 ms-2 ">
        ...
        <div className="col-12 col-sm-6 text-center align-middle ">
          <div class="input-group  mt-0 mt-sm-3">
            <input
              type="text"
              class="form-control"
        ...
        <div className=" m-0 p-1 pe-3 col-3 d-sm-block d-none text-end ">
          <img
      ...
      <hr className="m-1" />
      <div className="youtube-content bg-light row container p-0 mx-auto">
        <div className="col-12 col-lg-8">
          <iframe
            height="415"
            src={"https://www.youtube.com/embed/" + data[nowShow].id}
            ...
            className="w-100"
          ></iframe>
          <p className="fs-3 text-start">{data[nowShow].title}</p>
          <div className="fs-6  w-100 youtube-viewlike">
            <div className="text-start d-inline-block youtube-view">
              {data[nowShow].view}
            </div>
            <div className="text-end d-inline-block youtube-like">
              <svg
            ...
            <hr className="youtube-viewlike-hr m-0 mt-3" />
          </div>
          <br />
          <br />
          ...
          <hr />
          <div className="text-start">{data[nowShow].comment}</div>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae,
          soluta fugiat expedita tenetur exercitationem laborum, voluptas in
          dignissimos velit illum dolor, magni ea! Modi sed culpa voluptatibus
              ...
              return (
                <div className="row mb-2" onClick={() => setNowShow(i)}>
                  ...
                  <div className="col-7 text-start  youtube-recomment-title">
                    ...
                    <br />
                    <p className="youtube-recomment-author">
                      {e.author}
                      <br />
                      {e.view}
                    </p>
